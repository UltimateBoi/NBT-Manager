...
namespace NBT_Manager
{
	...
	public partial class MainWindow : Window
	{
		...
		{
			string text = new WebClient().DownloadString("https://raw.githubusercontent.com/UltimateBoi/NBT-Manager/main/Version.txt");
			...
			if (flag)
			{
				...
				if (flag2)
				{
					Process.Start("https://github.com/UltimateBoi/NBT-Manager");
				}
			}
		}
